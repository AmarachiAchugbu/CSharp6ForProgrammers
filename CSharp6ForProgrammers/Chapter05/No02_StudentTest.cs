// Listing 5.2: StudentTest.cs
using System;

class No02_StudentTest
{
    private static void Main()
    {
        No01_Student student1 = new No01_Student("Jane Green", 93);
        No01_Student student2 = new No01_Student("John Blue", 72);
